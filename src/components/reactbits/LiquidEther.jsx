...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: dtValue, isBounce: bounceValue, BFECC: bfeccValue }) {
        this.uniforms.dt.value = dtValue;
        this.line.visible = bounceValue;
  ...
  return <div ref={mountRef} className={`liquid-ether-container ${className || ''}`} style={mountStyle} />;
}
